    ...
    FileEditor.prototype.render = function () {
        ...
        <Wrapper>
          <EditorWrapper_1.default>
            <QueryWrap>
              <QueryEditor_1.QueryEditor value={this.props.value} onChange={this.props.onChange}/>
            </QueryWrap>
          </EditorWrapper_1.default>
        </Wrapper>
...
exports.default = react_redux_1.connect(mapStateToProps, { onChange: actions_1.editFile })(FileEditor);
