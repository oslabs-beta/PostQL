...
exports.AddIcon = function (props) { return (<Svg {...props} viewBox="0 0 50 50">
    <line x1="25" y1="13.1" x2="25" y2="36.9"/>
    <line x1="36.9" y1="25" x2="13.1" y2="25"/>
  </Svg>); };
exports.AddFullIcon = function (props) { return (<Svg x="0px" y="0px" viewBox="-1 3 50 50" {...props}>
    <line x1="24" y1="7.27" x2="24" y2="48.73"/>
    <line x1="44.73" y1="28" x2="3.27" y2="28"/>
  </Svg>); };
exports.FullArrowRightIcon = function (props) { return (<Svg {...props} viewBox="0 0 14 11">
...
//   </Svg>
// )
exports.SettingsIcon = function (props) { return (<Svg {...props} viewBox="0 0 50 50">
...
exports.CrossIcon = function (props) { return (<Svg {...props} viewBox="0 0 50 50">
    <line x1="4" y1="4" x2="46" y2="46"/>
    <line x1="46" y1="4" x2="4" y2="46"/>
  </Svg>); };
exports.ArrowRight = function (props) { return (<Svg width={14} height={11} {...props} viewBox="-1 -1 14 11">
    <path d="M5,8.79825579 L5,-1.79402089" id="Stroke-3" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" transform="translate(5.750000, 3.502117) rotate(-90.000000) translate(-5.750000, -3.502117) "/>
    <polyline id="Stroke-5" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" transform="translate(9.868295, 4.333992) rotate(-90.000000) translate(-9.868295, -4.333992) " points="14.2022868 2.16699605 9.86829475 6.50098814 5.53430265 2.16699605"/>
  </Svg>); };
exports.History = function (props) { return (<Svg {...props} viewBox="0 0 50 50" fill="none">
...
exports.Star = function (_a) {
    var height = _a.height, width = _a.width, stroke = _a.stroke, fill = _a.fill, strokeWidth = _a.strokeWidth, onClick = _a.onClick, props = __rest(_a, ["height", "width", "stroke", "fill", "strokeWidth", "onClick"]);
    return (<Svg width={width} height={height} fill={fill ? fill : 'none'} stroke={stroke ? stroke : 'none'} strokeWidth={strokeWidth} viewBox="118 12 16 16" onClick={onClick} {...props}>
...
exports.Search = function (_a) {
    var height = _a.height, width = _a.width, strokeWidth = _a.strokeWidth, color = _a.color, props = __rest(_a, ["height", "width", "strokeWidth", "color"]);
    return (<Svg width={width} height={height} viewBox="0 0 50 50" strokeWidth={strokeWidth} stroke={color} fill="none" {...props}>
...
exports.ShareIcon = function (_a) {
    ...
    return (<Svg width={width} height={height} viewBox="0 0 50 50" stroke={color} {...props}>
...
exports.Triangle = function (props) { return (<Svg width={6} height={7} viewBox="40 0 6 7" {...props}>
    <polygon stroke="none" fill="rgba(0, 0, 0, .2)" fillRule="evenodd" points="40 7 40 0 46 3.5"/>
  </Svg>); };
